...
var activity_avg_count = require('lib/activity_avg_count');
...
exports.add = function (deployments) {
  ...
  label = $(document.createTextNode('Activity Average Frequency'));
  button = $(document.createElement('a'))
               .attr({ id: 'avgfreq',
                       href: '#',
                       class: 'theme button white graph-button'
                     })
               .click(function () { activity_avg_count.create_chart(deployments); })
               .append(label);
  $('#buttons').append(button);
...
exports.reload = function (deployments) {
  ...
  $('#avgfreq').click(function () {
    activity_avg_count.create_chart(deployments); });
